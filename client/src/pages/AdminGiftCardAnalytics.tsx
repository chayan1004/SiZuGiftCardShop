...
import { 
  ...
  DollarSign, Target, Percent, Clock, Filter
} from "lucide-react";
...
export default function AdminGiftCardAnalytics() {
  ...
  // Fetch gift card analytics
  const { data: analyticsResponse, isLoading, refetch } = useQuery({
    queryKey: ['/api/admin/gift-card-analytics', selectedMerchant, dateRange, startDate, endDate],
    queryFn: async () => {
